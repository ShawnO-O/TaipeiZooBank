package com.zoo.taipeizoo.model.data.callApiResult.plantInfo

import com.google.gson.annotations.SerializedName

data class PlantInfoResults(
//    @SerializedName("data")
//    val plantInfoInfoData: PlantInfoData = PlantInfoData(),
    @SerializedName("status")
    val status: String = "",
    @SerializedName("statusText")
    val statusText: String = "",
    @SerializedName("result")
    val plantInfoDataResult: PlantInfoDataResult = PlantInfoDataResult()
)
...
data class PlantInfoDataResult(
    ...
    val results: ArrayList<ResultData> = ArrayList(),
    @SerializedName("sort")
    val sort: String = ""
)
